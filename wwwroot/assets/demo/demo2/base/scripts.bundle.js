    ...
    return {
        ...
        addClass: function (el, className) {
            ...
            if (el.classList) {
                ...
                for (var k = 0; k < classNames.length; k++) {
                    el.className += ' ' + KTUtil.trim(classNames[k]);
                }
            }
        },
        ...
        removeClass: function (el, className) {
            ...
            if (el.classList) {
                ...
                for (var k = 0; k < classNames.length; k++) {
                    el.className = el.className.replace(new RegExp('\\b' + KTUtil.trim(classNames[k]) + '\\b', 'g'), '');
                }
            }
        },
        ...
        triggerEvent: function (node, eventName) {
            ...
            if (node.dispatchEvent) {
                ...
                // IE-old school style
                var events = doc.createEventObject();
                events.synthetic = true; // allow detection of synthetic events
                node.fireEvent("on" + eventName, events);
            }
        },
